package com.shop.happy.happyshop.ui.widget;
 ...
 *
 * @see <a href="https://mobikul.com/adding-badge-count-on-menu-items-like-cart-notification-etc/">Refered here</a>
 */
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.color_white));
